...
CREATE FUNCTION public.get_all_cms_pages() RETURNS TABLE(id integer, page_name character varying, page_title character varying, page_slug character varying, is_active boolean, updated_at timestamp without time zone)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY
...
CREATE SEQUENCE public.blog_submissions_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE TABLE public.cms_page_achievements (
    id integer NOT NULL,
    page_id integer,
...
CREATE SEQUENCE public.cms_page_achievements_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE TABLE public.cms_page_hubs (
    id integer NOT NULL,
    page_id integer,
...
CREATE SEQUENCE public.cms_page_hubs_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE TABLE public.cms_page_section_items (
    id integer NOT NULL,
    section_id integer,
...
CREATE SEQUENCE public.cms_page_section_items_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE SEQUENCE public.cms_page_sections_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE TABLE public.cms_page_stats (
    id integer NOT NULL,
    page_id integer,
...
CREATE SEQUENCE public.cms_page_stats_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE TABLE public.cms_page_team (
    id integer NOT NULL,
    page_id integer,
...
CREATE SEQUENCE public.cms_page_team_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE TABLE public.cms_page_testimonials (
    id integer NOT NULL,
    page_id integer,
...
CREATE SEQUENCE public.cms_page_testimonials_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE TABLE public.cms_page_timeline (
    id integer NOT NULL,
    page_id integer,
...
CREATE SEQUENCE public.cms_page_timeline_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE TABLE public.cms_page_values (
    id integer NOT NULL,
    page_id integer,
...
CREATE SEQUENCE public.cms_page_values_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE TABLE public.kalam_submissions (
    id integer NOT NULL,
    kalam_id integer,
    status character varying(50) DEFAULT 'draft'::character varying,
...
CREATE SEQUENCE public.kalam_submissions_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE SEQUENCE public.kalams_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE SEQUENCE public.partnership_proposals_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE TABLE public.remote_recording_requests (
    id integer NOT NULL,
    vocalist_id integer,
    kalam_id integer,
...
CREATE SEQUENCE public.remote_recording_requests_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE TABLE public.remote_recording_requests_new (
    id integer NOT NULL,
    vocalist_id integer,
    kalam_id integer,
...
CREATE SEQUENCE public.remote_recording_requests_new_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE TABLE public.special_recognitions (
    id integer NOT NULL,
    title character varying(255) NOT NULL,
...
CREATE SEQUENCE public.special_recognitions_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE TABLE public.studio_recording_requests (
    id integer NOT NULL,
    vocalist_id integer,
    kalam_id integer,
    lyric_title character varying(255) NOT NULL,
...
CREATE SEQUENCE public.studio_recording_requests_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE TABLE public.studio_visit_requests (
    id integer NOT NULL,
    vocalist_id integer,
    kalam_id integer,
    name character varying(255),
...
CREATE SEQUENCE public.studio_visit_requests_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE INDEX idx_blog_submissions_category ON public.blog_submissions USING btree (category);
...
CREATE INDEX idx_blog_submissions_created_at ON public.blog_submissions USING btree (created_at);
...
CREATE INDEX idx_blog_submissions_language ON public.blog_submissions USING btree (language);
...
CREATE INDEX idx_blog_submissions_status ON public.blog_submissions USING btree (status);
...
CREATE INDEX idx_blog_submissions_user_id ON public.blog_submissions USING btree (user_id);
...
CREATE INDEX idx_bloggers_created_at ON public.bloggers USING btree (created_at);
...
CREATE INDEX idx_bloggers_user_id ON public.bloggers USING btree (user_id);
...
CREATE INDEX idx_cms_page_achievements_page_id ON public.cms_page_achievements USING btree (page_id);
...
CREATE INDEX idx_cms_page_hubs_page_id ON public.cms_page_hubs USING btree (page_id);
...
CREATE INDEX idx_cms_page_section_items_section_id ON public.cms_page_section_items USING btree (section_id);
...
CREATE INDEX idx_cms_page_stats_page_id ON public.cms_page_stats USING btree (page_id);
...
CREATE INDEX idx_cms_page_team_page_id ON public.cms_page_team USING btree (page_id);
...
CREATE INDEX idx_cms_page_testimonials_page_id ON public.cms_page_testimonials USING btree (page_id);
...
CREATE INDEX idx_cms_page_timeline_page_id ON public.cms_page_timeline USING btree (page_id);
...
CREATE INDEX idx_cms_page_values_page_id ON public.cms_page_values USING btree (page_id);
...
CREATE INDEX idx_cms_pages_slug ON public.cms_pages USING btree (page_slug);
...
CREATE INDEX idx_remote_recording_created_at ON public.remote_recording_requests USING btree (created_at);
...
CREATE INDEX idx_remote_recording_kalam_id ON public.remote_recording_requests USING btree (kalam_id);
...
CREATE INDEX idx_remote_recording_new_created_at ON public.remote_recording_requests_new USING btree (created_at);
...
CREATE INDEX idx_remote_recording_new_kalam_id ON public.remote_recording_requests_new USING btree (kalam_id);
...
CREATE INDEX idx_remote_recording_new_status ON public.remote_recording_requests_new USING btree (status);
...
CREATE INDEX idx_remote_recording_new_vocalist_id ON public.remote_recording_requests_new USING btree (vocalist_id);
...
CREATE INDEX idx_remote_recording_status ON public.remote_recording_requests USING btree (status);
...
CREATE INDEX idx_remote_recording_vocalist_id ON public.remote_recording_requests USING btree (vocalist_id);
...
CREATE INDEX idx_studio_recording_created_at ON public.studio_recording_requests USING btree (created_at);
...
CREATE INDEX idx_studio_recording_kalam_id ON public.studio_recording_requests USING btree (kalam_id);
...
CREATE INDEX idx_studio_recording_status ON public.studio_recording_requests USING btree (status);
...
CREATE INDEX idx_studio_recording_vocalist_id ON public.studio_recording_requests USING btree (vocalist_id);
...
CREATE INDEX idx_studio_visit_created_at ON public.studio_visit_requests USING btree (created_at);
...
CREATE INDEX idx_studio_visit_kalam_id ON public.studio_visit_requests USING btree (kalam_id);
...
CREATE INDEX idx_studio_visit_status ON public.studio_visit_requests USING btree (status);
...
CREATE INDEX idx_studio_visit_vocalist_id ON public.studio_visit_requests USING btree (vocalist_id);
...
CREATE INDEX idx_users_country_city ON public.users USING btree (country, city);
...
CREATE INDEX idx_vocalists_created_at ON public.vocalists USING btree (created_at);
...
CREATE INDEX idx_vocalists_status ON public.vocalists USING btree (status);
...
CREATE INDEX idx_vocalists_user_id ON public.vocalists USING btree (user_id);
...
CREATE INDEX idx_writer_user_id ON public.writers USING btree (user_id);
...
CREATE INDEX idx_youtube_videos_title ON public.youtube_videos USING btree (title);
...
CREATE INDEX idx_youtube_videos_uploaded_at ON public.youtube_videos USING btree (uploaded_at DESC);
